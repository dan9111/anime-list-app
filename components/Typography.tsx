...
export const H1 = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  function H1({ className, children, ...props }, ref) {
    return (
      <h1
        {...props}
        ref={ref}
...
export const H2 = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  function H2({ className, children, ...props }, ref) {
    return (
      <h2
        {...props}
        ref={ref}
...
export const H3 = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  function H3({ className, children, ...props }, ref) {
    return (
      <h3
        {...props}
        ref={ref}
...
export const H4 = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  function H4({ className, children, ...props }, ref) {
    return (
      <h4
        {...props}
        ref={ref}
...
export const Ul = React.forwardRef<HTMLUListElement, TypographyProps>(
  function Ul({ className, children, ...props }, ref) {
    return (
      <ul
        {...props}
        ref={ref}
...
export const Code = React.forwardRef<HTMLElement, TypographyProps>(
  function Code({ className, children, ...props }, ref) {
    return (
      <code
        {...props}
        ref={ref}
...
export const LeadParagraph = React.forwardRef<
  HTMLParagraphElement,
  TypographyProps
>(function Lead({ className, children, ...props }, ref) {
  return (
    <p
      {...props}
      ref={ref}
...
export const LargeParagraph = React.forwardRef<
  HTMLParagraphElement,
  TypographyProps
>(function Large({ className, children, ...props }, ref) {
  return (
    <p {...props} ref={ref} className={cn("text-lg font-semibold", className)}>
      {children}
    </p>
  );
});

export const SmallParagraph = React.forwardRef<
  HTMLParagraphElement,
  TypographyProps
>(function Small({ className, children, ...props }, ref) {
  return (
    <p
      {...props}
      ref={ref}
...
export const MutedParagraph = React.forwardRef<
  HTMLParagraphElement,
  TypographyProps
